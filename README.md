...
- JSON-выгрузка, готовая для кнопочного интерфейса, Telegram или CRM.

Источник HH.ru удалён как нерелевантный. Следующий рабочий срез — коннекторы к проектным источникам и кнопка немедленного запуска.
...
Для запуска на небольшом Ubuntu VPS подготовлены Dockerfile и Docker Compose: [docs/vps-deployment.md](docs/vps-deployment.md). Расписание отключено: основной режим — запрос по кнопке.
